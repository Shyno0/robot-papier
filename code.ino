...
char commande;    // Variable commande afin de lire le Moniteur serie
...
void CommandeRobot() // code pour controler le robot a l'aide du moniteur serie (code a mettre dans le void loop)
{
